...
class PhoneModelCreateRequest extends FormRequest
{
    /**
    ...
    {
        // Allow this request (authentication/authorization should be handled elsewhere)
        return true;
    }
    ...
    {
        return [
            'name' => 'required|string|max:255|unique:phone_models,model_name',
            ...
            'available_color.*.name' => 'nullable|string',
            'available_color.*.value' => 'nullable|string',
