                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-control" id="ram_option_id" name="ram_option_id" required>
                                        ...
                                        @foreach(($ramOptions ?? []) as $opt)
                                            <option value="{{ $opt->id }}" @selected(old('ram_option_id', $device->ram_option_id) == $opt->id)>{{ $opt->value }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-control" id="storage_option_id" name="storage_option_id" required>
                                        ...
                                        @foreach(($storageOptions ?? []) as $opt)
                                            <option value="{{ $opt->id }}" @selected(old('storage_option_id', $device->storage_option_id) == $opt->id)>{{ $opt->value }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                        ...
                                        <div class="d-flex gap-2 mb-1" id="existing-color-group">
                                            <select class="form-control" id="color_option_id" name="color_option_id">
                                                ...
                                                @foreach(($colorOptions ?? []) as $opt)
                                                    <option value="{{ $opt->id }}" @selected(old('color_option_id', $device->color_option_id) == $opt->id)>{{ $opt->name }}</option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-control" id="warranty_id" name="warranty_id">
                                        ...
                                        @foreach(($warranties ?? []) as $w)
                                            <option value="{{ $w->id }}" @selected(old('warranty_id', $device->warranty_id) == $w->id)>
