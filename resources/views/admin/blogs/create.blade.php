...
<style>
    ...
    .image-preview-item img { border: 1px solid #ddd; border-radius: 4px; width: 80px; height: 80px; object-fit: cover; }
    .image-preview-item .remove-image-btn { position: absolute; top: -5px; right: -5px; border-radius: 50%; width: 20px; height: 20px; padding: 0; font-size: 10px; line-height: 1; }
                        ...
                        @else
                            <div class="section-block">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">Section Images</label>
                                        <input type="file" id="section_images_0" name="section_images[0][]"
                                            class="form-control" accept="image/*" multiple>
                                        <div class="section-images-preview mt-2" data-target="section_images_0"></div>
                                        <div class="section-images-data" data-target="section_images_0"></div>
                                    </div>
                                    <div class="col-12 mb-2">
                                        <label class="form-label">Content <span class="text-danger">*</span></label>
                                        <textarea name="section_contents[]" id="section_contents_0"
...
$(document).ready(function () {
    let sectionIndex = {{ count(old('section_titles', [])) ?: 1 }};
    ...
    // ── Section Image File input → preview + hidden data ──
    ...
    // ── Thumbnail file → open cropper modal ──
    ...
    (function () {
        ...
        window.addEventListener('mousemove', e => {
            ...
            st.x = e.clientX - st.sx; st.y = e.clientY - st.sy; applyTransform();
        });
